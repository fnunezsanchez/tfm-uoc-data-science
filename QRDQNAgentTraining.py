...
from QRDQNAgentPolicy import QRDQNAgentPolicy
import numpy as np
import datetime
import time
import os
...
# Configurar callback para gráfica recompensa cada REWARD_EPISODE_FREQ
...
_learning_starts = 10
_train_freq = 4
_target_update_interval = 5000
_exploration_fraction = 0.45
_exploration_initial_eps = 0.5
...
policy_kwargs = dict(n_quantiles=70)


model = QRDQN(policy=QRDQNAgentPolicy,
            env=env,
            ...
            exploration_initial_eps = _exploration_initial_eps,
